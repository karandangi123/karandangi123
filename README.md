...
| :--- | :---: | :--- | :--- |
| [**RetailRocket E-Commerce Analytics**](https://github.com/karandangi123/retailrocket-ecommerce-analytics) | 2026 | Python, SQL, Matplotlib, Seaborn | Executive analytics case study analyzing the end-to-end ***customer journey*** and ***conversion funnel*** using ***2.75M*** e-commerce events to uncover ***revenue leakage***, ***retention gaps***, and ***merchandising opportunities***. Built with Python and SQLite, delivering ***executive-ready insights*** and ***strategic business recommendations***. |
